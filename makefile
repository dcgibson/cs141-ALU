...
alu: 
	$(CC) -o alu.o alu.v alu_defines.v and.v ripple_adder.v mux_16to1.v nor.v or.v test_alu.v xor.v full_adder.v half_adder.v mux_8to1.v mux_4to1.v mux_2to1.v
	vvp alu.o

ripple:
	$(CC) -o ripple.o test_ripple_adder32.v ripple_adder.v full_adder.v
	vvp ripple.o
